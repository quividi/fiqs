...
def test_total_sales_by_period(elasticsearch_sale, interval, pretty_period):
    ...
    write_fquery_output(
        ...
        f"total_sales_{pretty_period}_by_{pretty_period}",
    )
...
def test_nb_sales_by_date_range_with_keys(elasticsearch_sale, date_ranges_with_keys):
    write_fquery_output(
        FQuery(get_search())
        .values(
            Count(Sale),
...
def test_nb_sales_by_date_range_by_payment_type(
    elasticsearch_sale, date_ranges_with_keys
):
...
def test_nb_sales_by_grouped_shop_by_payment_type(elasticsearch_sale, shops_by_group):
...
def test_nb_sales_by_payment_type_by_grouped_shop(elasticsearch_sale, shops_by_group):
...
def test_nb_sales_by_product_type_by_part_id_filter_product_type_1(elasticsearch_sale):
